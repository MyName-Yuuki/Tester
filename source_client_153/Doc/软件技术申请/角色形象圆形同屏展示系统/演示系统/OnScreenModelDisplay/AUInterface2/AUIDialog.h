...
public:
	...
	PAUIOBJECT CreateControl(A3DEngine *pA3DEngine, A3DDevice *pA3DDevice, int idControl, bool bAddToDialog = true);
	...
	void AddFrame(A3DViewport *pViewport, A3DRECT &rc);
	void DelFrame(A3DViewport *pViewport);
	void ChangeFrame(A3DViewport *pViewport, A3DRECT &rc);
	...
	bool DealWindowsMessage(UINT uMsg, WPARAM wParam, LPARAM lParam, bool bKeyboard);
	...
	bool GetProperty(const char *pszPropertyName, PAUIOBJECT_SETPROPERTY Property);
