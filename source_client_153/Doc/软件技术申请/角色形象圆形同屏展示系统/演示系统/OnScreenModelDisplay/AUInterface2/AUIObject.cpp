...
POINT AUIObject::GetPos(bool bLocal)
{
	POINT ptPos;
...
bool AUIObject::SetProperty(const  char *pszPropertyName, PAUIOBJECT_SETPROPERTY Property)
{
	...
	else if( 0 == strcmpi(pszPropertyName, "Font") )
	{
		...
		SetFontAndColor(m_szFontName, m_nFontHeight, m_color, Property->i, m_nOutline, m_bBold, m_bItalic, m_bFreeType, m_clOutline, m_clInnerText, m_bInterpColor, m_clUpper, m_clLower);
	else if( 0 == strcmpi(pszPropertyName, "Outline") )
