...
void AUIRadioButton::PrintOptimizeResource()const
{
	glb_PrintOptimizeResource(m_pA2DSpriteNormal);	
	glb_PrintOptimizeResource(m_pA2DSpriteChecked);	
	glb_PrintOptimizeResource(m_pA2DSpriteOnHover);	
	glb_PrintOptimizeResource(m_pA2DSpriteCheckedOnHover);
}
