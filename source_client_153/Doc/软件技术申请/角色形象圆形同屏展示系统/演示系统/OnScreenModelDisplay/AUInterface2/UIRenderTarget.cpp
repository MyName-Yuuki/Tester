...
bool UIRenderTarget::CreateRenderTarget()
{
	...
	if(!m_pRenderTarget->Init( m_pA3DDevice, devFmt, true, false))
		return false;
	...
	if( !m_pAlphaRT->Init(m_pA3DDevice, devFmt, true, false))
	{
		return false;
	}
...
bool UIRenderTarget::BeginRenderRT()
{
	...
	m_pA3DDevice->GetD3DDevice()->SetRenderState(D3DRS_COLORWRITEENABLE, D3DCOLORWRITEENABLE_RED | D3DCOLORWRITEENABLE_GREEN | D3DCOLORWRITEENABLE_BLUE);
...
bool UIRenderTarget::BeginRenderRTAlpha()
{
	...
	m_pA3DDevice->SetDestAlpha(A3DBLEND_INVSRCALPHA);
	//m_pA3DDevice->GetD3DDevice()->SetRenderState(D3DRS_COLORWRITEENABLE, D3DCOLORWRITEENABLE_ALPHA);
...
bool UIRenderTarget::EndRenderRT()
{
	...
	m_pA3DDevice->SetSourceAlpha(A3DBLEND_SRCALPHA);
	m_pA3DDevice->SetDestAlpha(A3DBLEND_INVSRCALPHA);
	m_pA3DDevice->GetD3DDevice()->SetRenderState(D3DRS_COLORWRITEENABLE, D3DCOLORWRITEENABLE_RED | D3DCOLORWRITEENABLE_GREEN | D3DCOLORWRITEENABLE_BLUE|D3DCOLORWRITEENABLE_ALPHA);
