...
{
	return ch >= 33 && ch <= 126 || ch >= 0x401 && ch <= 0x451
...
public:
	...
	EditBoxItemBase(EditboxItemType type) : m_type(type), m_dwColor(0xffffffff), m_nMsgIndex(0), m_nImageIndex(0), m_nImageFrame(0), m_fImageScale(1.0f),
		m_pExtraData(NULL), m_uExtraDataSize(0), m_bUnderLine(false), m_bSameColor(true), m_dwUnderLineColor(0) 
	{
