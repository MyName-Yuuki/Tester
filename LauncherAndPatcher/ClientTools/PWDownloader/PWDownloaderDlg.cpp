...
BOOL CPWDownloaderDlg::OnInitDialog()
{
	...
	// ===== SET PCK VERIFICATION KEY =====
	// IMPORTANT: Set key sebelum proses update/extract!
	// Pilih salah satu format di bawah ini:

	// Option 1: Plain text
	PCK_SetKey("RAHASIA123");

	// Option 2: Base64 (auto-decode)
	// PCK_SetKey("UkFIQVNJQTEyMw==");

	// NOTE: Ganti "RAHASIA123" dengan key Anda sendiri!
	// =============================================
	...
	SetTimer(0, 100, NULL);		// ������Tick
	SetTimer(1, 500, NULL);		// ���µ�ǰ������Ϣ
//	SetTimer(2, 1000, NULL);	// ���ͻ����Ƿ��˳�
...
void CPWDownloaderDlg::OnTimer(UINT nIDEvent) 
{
	...
	else if( nIDEvent == 1 )
	{
		...
		if( m_bDownloadOK )
		{
			...
			{
				if( MessageBox(_T("��������������ͻ�����������ϣ�Ҫ��ʼ��װ��"), _T("��ʾ"), MB_YESNO|MB_ICONQUESTION)
					== IDYES )
				{
					dl.Install();
				}
		...
		if( iErrCode > 0 )
		{
			...
			MessageBox(strMsg, "����", MB_OK|MB_ICONERROR);
		}
	}
// 	else if( nIDEvent == 2 )
// 	{
